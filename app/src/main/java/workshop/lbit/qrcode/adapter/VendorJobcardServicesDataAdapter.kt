...
class VendorJobcardServicesDataAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val itemView = layoutInflater.inflate(R.layout.vendor_jobcard_services_data_row, container, false)
        ...
        tv_service.text = mJCData.jc_service
        tv_cost.text = mJCData.jc_mrp
