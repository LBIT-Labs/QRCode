...
class JobcardSparesDataAdapter(
    ...
    lateinit var tv_pps_jobid: MyTextView_Roboto_Medium
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val itemView = layoutInflater.inflate(R.layout.jobcard_spares_data_row, container, false)
        ...
        tv_pps_jobid = itemView.findViewById(R.id.tv_pps_jobid)
        tv_edit = itemView.findViewById(R.id.tv_edit)
        tv_delete = itemView.findViewById(R.id.tv_delete)

        tv_pps_part_no.text = mJCData.jc_oe_part
        ...
        tv_pps_jobid.text = mJCData.jc_job_id
